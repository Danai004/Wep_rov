...
<center>
            <div class="col-12 col-lg-12 <?php echo $bg?> p-2 mb-2" style="border-radius: 1vh;">
                <div class="d-flex justify-content-between">
                    ...
                    <h3 class=" m-0"><img src="assets/icon/application.png" class="m-0 mb-2" style="height: 2.5rem;">&nbsp; จัดการแนะนำ</h3>
                    </div>
                            ...
                            <div class="container-fluid <?php echo $bg?> p-4 pt-5 rounded shadow-sm border-ys count-only" style="border-radius: 1vh;">
                                <a href="?page=crecom_manage" style="text-decoration: none;">
                                    <center>
                                        ...
                                        <h2 class="m-0 mb-2">จัดการหมวดหมู่แนะนำ</span></h2>
                                        <small class="m-0 mb-2">สามารถจัดการหมวดหมู่แนะนำได้ที่นี่</span></small>
                                    </center>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="container-fluid <?php echo $bg?> p-4 pt-5 rounded shadow-sm border-ys count-only" style="border-radius: 1vh;">
                                <a href="?page=recom_manage" style="text-decoration: none;">
                                    <center>
                                        ...
                                        <h2 class="m-0 mb-2">จัดการสินค้าแนะนำ</span></h2>
                                        <small class="m-0 mb-2">สามารถจัดการสินค้าแนะนำได้ที่นี่</span></small>
                                    </center>
                                </a>
                            </div>
                        </div>
