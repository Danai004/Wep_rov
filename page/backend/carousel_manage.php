<div class="container-sm <?php echo $bg?>   mt-5 shadow-sm p-4 mb-4" data-aos="fade-down">
    ...
    <div class="d-flex justify-content-center">
        <button class="ms-2 me-2 mt-3 mb-0 btn btn-success col-12 col-lg-5 text-white" id="open_insert"> เพิ่มภาพใหม่</button>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <script>
            ...
            $("#save_btn").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/carousel_update.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            $("#insert_btn").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/carousel_insert.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            function get_detail(id){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/call/carousel_detail.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            function del(id , username){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'services/backend/carousel_del.php',
                            data:formData,
                            contentType: false,
                            processData: false,   
                        }).done(function(res){
