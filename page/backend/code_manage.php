<div class="container-sm <?php echo $bg?>   mt-5 shadow-sm p-4 mb-4" data-aos="fade-down">
    <center>
        <h1 class="">&nbsp;<i class="fa-duotone fa-code"></i>&nbsp;จัดการโค้ด</h1>
    </center>
    <hr>
    <div class="d-flex justify-content-center">
        <button class="ms-2 me-2 mt-3 mb-0 btn btn-success col-12 col-lg-5 text-white" id="open_insert"> เพิ่มโค้ดใหม่</button>
    </div>
            ...
            <tbody>
                ...
                ?>
                    <tr >
                        ...
                        <td class=""><?php echo htmlspecialchars($row['prize']);?></td>
                        <td class=""><?php echo number_format($row['count']);?></td>
                        <td class=""><?php echo number_format($row['max_count']);?></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-10 m-cent ">
                    <div class="mb-2">
                        <div class="mb-2">
                            <p class=" mb-1 text-dark">กำหนดโค้ด <span class="text-danger">*</span></p>
                            <input type="text" id="code" class="form-control" value="">
                        </div>
                        <div class="mb-2">
                            <p class=" mb-1 text-dark">จำนวนเงินที่ได้รับ <span class="text-danger">*</span></p>
                            <input type="text" id="reward" class="form-control" value="">
                        </div>
                        <div class="mb-2">
                            <p class=" mb-1 text-dark">จำกัดจำนวนคนรับ <span class="text-danger">*</span></p>
    ...
    <div class="modal-dialog">
        ...
        <script>
            ...
            $("#save_btn").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/code_update.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            $("#insert_btn").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/code_insert.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            function get_detail(id){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/call/code_detail.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            function del(id , username){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'services/backend/code_del.php',
                            data:formData,
                            contentType: false,
                            processData: false,   
                        }).done(function(res){
