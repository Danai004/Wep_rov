<div class="container-sm <?php echo $bg?> mt-5 mb-5  shadow-sm p-4 " style="z-index: 55;">
    ...
    <div class="row justify-content-start">
        ...
        <div class="col-lg-3 mb-3">
            <a href="?page=website" class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-duotone fa-browser"></i></h1>
                <h4 class="text-main">จัดการเว็บไซต์</h4>
            </a>
        </div>
        <div class="col-lg-3 mb-3">
            <a href="?page=website" class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-duotone fa-browser"></i></h1>
                <h4 class="text-main">จัดการ Theme</h4>
            </a>
        </div>
        <div class="col-lg-3 mb-3">
            <a href="?page=user_edit"  class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-duotone fa-users"></i></h1>
                <h4 class="text-main">จัดการผู้ใช้</h4>
            </a>
        </div>
        <div class="col-lg-3 mb-3">
        ...
        <div class="col-lg-3 mb-3">
            <a href="?page=product_manage"class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-light fa-boxes-stacked"></i></h1>
                <h4 class="text-main">จัดการวงล้อ</h4>
            </a>
        </div>
        <div class="col-lg-3 mb-3">
            <a href="?page=code_manage"class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-solid fa-code"></i></h1>
                <h4 class="text-main">จัดการโค้ด</h4>
            </a>
        </div>
        <div class="col-lg-3 mb-3">
            <a  href="?page=backend_buy_history" class="btn border-main-gra btn-up w-100">
                <h1 class="text-main"><i class="fa-duotone fa-history"></i></h1>
                <h4 class="text-main">ประวัติการสั่งซื้อ</h4>
            </a>
        </div>
        <div  class="col-lg-3 mb-3">
