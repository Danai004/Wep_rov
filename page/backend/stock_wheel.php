    ...
    <div class="modal-dialog">
        ...
        <script>
            ...
            $("#save_btn").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/stock_wheel_update.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            $("#insert_btn").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/stock_wheel_insert.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            function get_detail(id){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/call/stock_wheel_detail.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            function del(id , username){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'services/backend/stock_wheel_del.php',
                            data:formData,
                            contentType: false,
                            processData: false,   
                        }).done(function(res){
