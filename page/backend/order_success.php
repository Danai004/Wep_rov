<div class="container-sm p-4" data-aos="<?php echo $anim; ?>">
    ...
    <div class="table-responsive mt-3 ">
        ...
        <center>
                <h2>Order ที่สำเร็จแล้ว</h2>
            </center>
            <div class="mb-2">
            <button class="btn text-white bg-main w-100" onclick="del()">ย้ายไปถังขยะทั้งหมด</button>
        </div>
            <thead class="table">
                <tr class="">
            ...
            <tbody>
                <?php
                $get_user = dd_q("SELECT * FROM service_order WHERE status = ? AND del = 'no' ORDER BY id DESC", ["yes"]);
    ...
    function del() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/order_temp.php',
                    data: formData,
                    contentType: false,
                    processData: false,
                }).done(function(res) {
