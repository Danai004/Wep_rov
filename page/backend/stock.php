...
?>
<div class="container-sm <?php echo $bg?> mt-5 border-2 shadow-sm p-4 mb-4" data-aos="fade-down">
    <center>
    ...
    <div class="d-flex row justify-content-center">
        ...
        <button class="ms-2 me-2 mt-3 mb-0 btn btn-outline-danger col-12 col-lg-3 " onclick="clean(<?= $_GET['id'] ?>)"> ล้างสต๊อก</button>
    </div>
            ...
            <tbody>
                ...
                ?>
                    <tr >
                        ...
                        <td class=""><?php echo htmlspecialchars($row['password']);?></td>
    ...
    <div class="modal-dialog">
        ...
        <script>
            ...
            $("#salt_btn").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/product_salt_update.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            $("#save_btn").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/stock_update.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            $("#insert_btn").click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/stock_insert.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            function get_detail(id){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/call/stock_detail.php',
                    data:formData,
                    contentType: false,
                    processData: false,   
                }).done(function(res){
            ...
            function del(id , username){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'services/backend/stock_del.php',
                            data:formData,
                            contentType: false,
                            processData: false,   
                        }).done(function(res){
            ...
            function clean(id) {
                Swal.fire({
                    title: 'ยืนยันที่จะล้าง?',
                    text: "คุณแน่ใจรึล้างสต๊อก",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'services/backend/stock_clean.php',
                            data: formData,
                            contentType: false,
                            processData: false,
                        }).done(function(res) {
