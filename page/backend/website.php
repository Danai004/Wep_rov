    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-white" id="exampleModalLabel"><i class="fa-duotone fa-pencil"></i>&nbsp;&nbsp;ตั้งค่าจำนวนโชว์บนเว็บไซต์</h5>
...
<div class="container-sm <?php echo $bg?>  mt-5  shadow-sm p-4 mb-4 rounded" data-aos="fade-down">
    ...
    <div class="mb-2">
        <center>
        <button class="btn w-50 btn-primary text-white" id="open_insert">ตั้งค่าจำนวนโชว์บนเว็บไซต์</button>
        </center>
    </div>
    <div class="col-lg-6 m-auto">
        ...
        <div class="mb-2 mt-4">
            <p class="m-0  ">Webhook Discord (ลิงค์) <span class="text-danger">*</span></p>
            <input type="text" id="webhook" class="form-control" value="<?php echo $config['webhook_dc']; ?>">
        </div>
...
<script type="text/javascript">
    $("#insert_btn").click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'services/backend/static_udpate.php',
            data: formData,
            contentType: false,
            processData: false,
        }).done(function(res) {
    ...
    $("#btn_regis").click(function(e) {
        ...
        formData.append('webhook_dc', $("#webhook").val());
