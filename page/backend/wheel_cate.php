<div class="container-sm  <?php echo $bg?>   mt-5  shadow-sm p-4 mb-4 rounded" data-aos="fade-down">
    ...
    <div class="d-flex justify-content-center">
        <button class="ms-2 me-2 mt-3 mb-0 btn btn-success col-12 col-lg-5 text-white" id="open_insert"> เพิ่มวงล้อใหม่</button>
    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select text-dark" id="p_type_product">
                                ...
                                <option value="0" selected style="color: #000">สุ่มวงล้อ</option>
                                <option value="1" style="color: #000">สุ่มหีบสมบัติ</option>
                            </select>
                        </div>
                    </div>
...
<script>
    ...
    $("#save_btn").click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'services/backend/wheel_update.php',
            data: formData,
            contentType: false,
            processData: false,
        }).done(function(res) {
    ...
    $("#insert_btn").click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'services/backend/wheel_insert.php',
            data: formData,
            contentType: false,
            processData: false,
        }).done(function(res) {
    ...
    function get_detail(id) {
        ...
        $.ajax({
            type: 'POST',
            url: 'services/backend/call/wheel_detail.php',
            data: formData,
            contentType: false,
            processData: false,
        }).done(function(res) {
    ...
    function del(id, username) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'services/backend/wheel_del.php',
                    data: formData,
                    contentType: false,
                    processData: false,
                }).done(function(res) {
